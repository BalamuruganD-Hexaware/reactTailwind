...
export const configurationAzure = {
  ...
  authority:
    'https://login.microsoftonline.com/7c0c36f5-af83-4c24-8844-9962e0163719/',
  authority_configuration: {
    issuer:
      'https://login.microsoftonline.com/7c0c36f5-af83-4c24-8844-9962e0163719/v2.0',
    authorization_endpoint:
      'https://login.microsoftonline.com/7c0c36f5-af83-4c24-8844-9962e0163719/oauth2/v2.0/authorize',
    token_endpoint:
      'https://login.microsoftonline.com/7c0c36f5-af83-4c24-8844-9962e0163719/oauth2/v2.0/token',
    end_session_endpoint:
      'https://login.microsoftonline.com/7c0c36f5-af83-4c24-8844-9962e0163719/oauth2/v2.0/logout',
  },
  refresh_time_before_tokens_expiration_in_second: 10,
  service_worker_relative_url: '/OidcServiceWorker.js',
  service_worker_only: false,
...
export const configurationGoogle = {
  client_id:
    '908893276222-f2drloh56ll0g99md38lv2k810d0nk0p.apps.googleusercontent.com',
  redirect_uri: `${window.location.origin}/multi-auth/callback-google`,
  silent_redirect_uri:
    window.location.origin + '/multi-auth/silent-callback-google',
